...
ifneq ($(filter oneplus8 oneplus8t oneplus8pro,$(TARGET_DEVICE)),)
...
ALL_DEFAULT_INSTALLED_MODULES +=  $(ACDBDATA_SYMLINKS) $(RFS_MDM_ADSP_SYMLINKS) $(RFS_MDM_CDSP_SYMLINKS) $(RFS_MDM_MPSS_SYMLINKS) $(RFS_MDM_SLPI_SYMLINKS) $(WLAN_FIRMWARE_SYMLINKS)
endif